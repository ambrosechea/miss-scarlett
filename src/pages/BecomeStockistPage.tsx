...
export default function BecomeStockistPage() {
  ...
  return (
    <>
      ...
      <PageHero
        eyebrow="PARTNER WITH MISS SCARLETT"
        title="Become a stockist"
        leftCellClassName="cell-26"
        image={group264}
        imageWidth={1138}
        imageHeight={832}
        imageSizes="(max-width: 767px) 100vw, (max-width: 991px) 95vw, 940px"
        imageSrcSet={`${group264_500} 500w, ${group264_800} 800w, ${group264_1080} 1080w, ${group264} 1138w`}
        imageAlt="Miss Scarlett luxury bridal gown — become a stockist"
      >
